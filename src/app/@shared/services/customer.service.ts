...
export class CustomerService {
  ...
  startCallToBuzzRing(callerData: Object): Observable<any>{
    const url = 'https://ring-dev-api.fuck.theater/api/customers/call-notification';
    return this.http.post(url, callerData);
  }
  
  startGroupCallToBuzzRing(callerData: Object): Observable<any>{
    const url = 'https://ring-api.fuck.theater/api/v1/customers/group-call-notification';
    return this.http.post(url, callerData);
  }
}
